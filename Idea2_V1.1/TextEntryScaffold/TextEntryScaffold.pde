...
void draw()
{
  ...
  noStroke();
  fill(255,0,0);
    rect(200+sizeOfInputArea, 200+sizeOfInputArea,0.5*sizeOfInputArea,0.5*sizeOfInputArea);
    textAlign(CENTER);
    fill(255);
    text("Delete", 200+sizeOfInputArea+0.25*sizeOfInputArea, 200+sizeOfInputArea+0.25*sizeOfInputArea);
